	...
	<body>
		<div id = "container">
			...
			<div class = "user-define">
				<h1>User List</h1>
				<p>*User Level 1 is a guest and has no privileges</p>
				<p>*User Level 2 is a Contributer and has privileges to articles</p>
				<p>*User Level 3 is a Administrator and has privileges articles, users &amp; Reports</p>
			</div>
			...
			<div class = "listControls">
				<div class = "button"><a href = "user-rest-list.php"><button>Restful User List</button></a></div>
				<div class = "button"><a href = "user-rest-single.php?userID=1"><button>Restful Single User</button></a></div>
			</div>
			<div class = "button"><a href = "users-report.php"><button>User Report</button></a></div>
		</div>
	</body>
</html>