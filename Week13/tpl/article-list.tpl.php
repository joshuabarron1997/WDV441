            ...
            <table border="1">
                ...
                { ?>
                    <tr>
                        ...
                        <td><a href="article-edit.php?articleID=<?php echo $articleData['articleID']; ?>">Edit</a></td>
                        <td><a href="article-view.php?articleID=<?php echo $articleData['articleID']; ?>">View</a></td>
